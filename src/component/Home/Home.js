...
<div  className="image-card"  style={{width: '400px', marginLeft: '35px', position: "relative", overflow: "hidden"}}>
<img className="doctor" width="35%" style={{borderRadius: '20px', marginTop: '5px'}} src={Old} alt="old-doctor"/>
...
<div  className="image-card"  style={{width: '400px', marginLeft: '35px', position: "relative", overflow: "hidden"}}>
<img className="doctor" width="35%" style={{borderRadius: '20px', marginTop: '5px'}} src={Dental} alt="dental-doctor"/>
...
<div  className="image-card"  style={{width: '400px', marginLeft: '35px', position: "relative", overflow: "hidden"}}>
<img className="doctor" width="35%" style={{borderRadius: '20px', marginTop: '5px'}} src={Women} alt="women-doctor"/>
...
<div  className="image-card"  style={{width: '400px', marginLeft: '35px', position: "relative", overflow: "hidden"}}>
<img className="doctor" width="35%" style={{borderRadius: '20px', marginTop: '5px'}} src={Heart} alt="women-doctor"/>
<h5>Dr. Aftab Gill</h5>
...
<div  className="image-card"  style={{width: '400px', marginLeft: '35px', position: "relative", overflow: "hidden"}}>
<img className="doctor" width="35%" style={{borderRadius: '20px', marginTop: '5px'}} src={Ear} alt="women-doctor"/>
...
<div  className="image-card"  style={{width: '400px', marginLeft: '35px', position: "relative", overflow: "hidden"}}>
<img className="doctor" width="35%" style={{borderRadius: '20px', marginTop: '5px'}} src={Eye} alt="women-doctor"/>
